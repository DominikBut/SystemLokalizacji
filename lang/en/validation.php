...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Podane hasło dla :attribute wystąpiło w wycieku danych. Proszę użyć innego hasła.',
    ],
    'present' => 'Pole :attribute musi być obecne.',
    'present_if' => 'Pole :attribute musi być obecne, gdy :other jest :value.',
    'present_unless' => 'Pole :attribute musi być obecne jeżeli :other jest :value.',
    'present_with' => 'Pole :attribute must być obecne, gdy :values jest obecne.',
    'present_with_all' => 'Pole :attribute must być obecne, gdy :values są obecne.',
    ...
    'required_if_declined' => 'Pole :attribute jest wymagane, gdy :other jest znegowane.',
