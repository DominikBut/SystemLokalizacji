<div>
    <h2 class="text-balance font-bold tracking-wider p-4 xl:p-6 text-lg lg:text-xl 2xl:text-2xl text-capitalize text-sky-950  bg-lime-100 border-x-4 border-lime-600 mb-4 ">
        Opcje zarządzania
    </h2>
     <!-- Navigation Links -->
    <div class="flex flex-col space-y-2 p-2 border-t-2 border-gray-300 md:pt-4 text-sm xl:text-base">

        <a href="{{ route('management.vehicles') }}" class="tracking-wide font-semibold  border-gray-300 px-3 py-2 md:py-3 xl:px-4  flex flex-col  text-wrap text-sky-950 border-x-2 border-lime-600
        ...
        <div class="border-b-2 border-gray-200 bg-gray-300 w-full"></div>
        <a href="{{ route('management.fence') }}" class="tracking-wide font-semibold  border-gray-300 px-3 py-2 md:py-3 xl:px-4  flex flex-col  text-wrap text-sky-950 border-x-2 border-lime-600
