<div>
    <h2 class="text-balance font-bold tracking-wider p-6 text-2xl text-capitalize text-sky-950 rounded-md bg-lime-100 border-x-4 border-lime-600 mb-4 ">
        Opcje zarządzania
    </h2>
     <!-- Navigation Links -->
    <div class="flex flex-col space-y-2 p-2 border-t-2 border-gray-300 pt-4">

        <a href="{{ route('management.vehicles') }}" class="tracking-wide font-semibold  border-gray-300 px-3 py-3 xl:px-4  flex flex-col rounded-r-lg rounded-l-lg text-wrap text-sky-950 border-x-2 border-lime-600
        ...
        <a href="{{ route('management.history') }}" class="tracking-wide font-semibold  border-gray-300 px-3 py-3 xl:px-4  flex flex-col rounded-r-lg rounded-l-lg text-wrap text-sky-950 border-x-2 border-lime-600
        ...
        <div class="border-b-2 border-gray-200 bg-gray-300 w-full"></div>
        <a href="{{ route('management.fence') }}" class="tracking-wide font-semibold  border-gray-300 px-3 py-3 xl:px-4  flex flex-col rounded-r-lg rounded-l-lg text-wrap text-sky-950 border-x-2 border-lime-600
        ...
        <div class="border-b-2 border-gray-200 bg-gray-300 w-full"></div>
        <a href="{{ route('management.oldmap') }}" class=" tracking-wide font-semibold  border-gray-300 px-3 py-3 xl:px-4  flex flex-col rounded-r-lg rounded-l-lg text-wrap text-sky-950 border-x-2 border-lime-600
